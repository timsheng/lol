...
describe 'consultant page', :consultant=>false do 
      ...
      it 'click experience cancel' do
        ...
        consultant_page.add_work_experience_element.click
        sleep 2
        consultant_page.experience_cancel
      end
      ...
      it 'click education cancel' do
        ...
        consultant_page.add_education_element.click
        sleep 2
        consultant_page.education_cancel
      end
    ...
    # end
      ...
      it 'consultant page search by keywords(school)english name' do
        ...
        consultant_page.search_element.when_present.click
        consultant_page.first_position_element.when_present.text.should eql "测试职位_junwei"
      end
      ...
      it 'add address' do
        ...
        sleep 2
        consultant_page.address = "上海市闸北区恒丰路439号"
        sleep 2
      ...
      it 'consultant profile page verify conatct solid star alert' do
        ...
        sleep 3
        consultant_page.contact_solid_star_alert_element.when_present.attribute_value("title").should eql "This is main contacts, you can click here to set it to unmain contacts"
      end
