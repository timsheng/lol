...
describe 'report page', :report=>false  do 
  ...
  let(:report_page)do 
    ...
    #client summary页面按renewal date查询记录
    ...
    it 'payment_report_page project_fee_page edit payment notes' do
      ...
      report_page.paynotes_input = "payment notes"
      report_page.paynotes_save_element.when_present.click
      report_page.payment_notes_element.when_present.text.should eql "payment notes"
    end
    ...
    #invoicing report页面的contact的链接
    it 'invoicing_report_page click contact link' do
      report_page.go_subpage "Invoicing"
      report_page.filter
      report_page.first_contact_invocing_element.when_present.click
      report_page.attach_to_window(:title=>report_page.first_contact_invocing_element.when_present.text+" - Capvision")
    ...
    it 'invoicing_report_page click project link' do
      ...
      report_page.attach_to_window(:title=>report_page.first_project_invocing_element.when_present.text+" - Task List - Capvision")
      report_page.task_list_element.when_present.text.should eql "Task List"
    end
    ...
    # it 'payment_report_page referral_fee_page click project link',:test do
    #   report_page.go_subpage "Payment"
    #   report_page.referralfee_link_element.when_present.click
    #   report_page.filter
    ...
    it 'full_consultant_page search by enrolled status' do
      ...
      report_page.filter
      report_page.text.include? "Qualified"
    end
    ...
    it 'consultant_growth_page search by created by' do
      report_page.go_subpage "Consultant Growth"
      report_page.select_createdby_cgrowth = "Admin"
      report_page.filter
      report_page.locate_first_createdby_cgrowth_element.when_present.text.should eql "Admin"
    end
    ...
    it 'consultant_growth_page search by communicated status' do
      ...
      report_page.filter
      report_page.list_status_cgrowth_element.when_present.text.should eql "Communicated"
    end
    ...
    it 'consultant_growth_page search by prospect status' do
      ...
      report_page.filter
      report_page.list_status_cgrowth_element.when_present.text.should eql "Prospect"
    end
    ...
    it 'consultant_growth_page search by invalid status' do
      ...
      report_page.filter
      report_page.list_status_cgrowth_element.when_present.text.should eql "Invalid" 
    end
    ...
    it 'consultant_growth_page search by blacklist status' do
      ...
      report_page.filter
      report_page.list_status_cgrowth_element.when_present.text.should eql "Blacklist"
    end
    ...
    it 'client_summary_page search by prospect status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Prospect"
      report_page.filter
    ...
    it 'client_summary_page search by engage status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Engage"
      report_page.filter
    ...
    it 'client_summary_page search by discover status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Discover"
      report_page.filter
    ...
    it 'client_summary_page search by trial status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Trial"
      report_page.filter
    ...
    it 'client_summary_page search by confirm status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Confirm"
      report_page.filter
    ...
    it 'client_summary_page search by annual status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Annual"
      report_page.filter
    ...
    it 'client_summary_page search by project status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Project"
      report_page.filter
    ...
    it 'client_summary_page search by close status' do
      report_page.go_subpage "Client Summary"
      report_page.client_status_summary = "Close"
      report_page.filter
    ...
    it 'client_cash_page search by am' do
      ...
      report_page.filter
      report_page.am_clientcash_report_element.when_present.text.should eql "test_am1"
    end
