...
describe 'convey page', :convey=>false do
	let(:project_convey_page) do
		...
		it 'create convey with nothing then click next button' do
			...
			project_convey_page.text.include? "Please fix the following input errors"
		end
		#建项目step1 [Consultants Requested]纯数字输入验证----输入qq#进行验证
		it 'create convey with consultants requested is qq#' do
			project_convey_page.create_convey
			project_convey_page.create_consultants_requested = "qq#"
			project_convey_page.create_next
			project_convey_page.text.include? "Consultants Requested must be a number."
		end
		...
		it 'create convey with consultants expected is qq#' do
			...
			project_convey_page.create_next
			project_convey_page.text.include? "Consultants Expected must be a number."
		end
		...
		it 'create convey with price is qq#' do
			...
			project_convey_page.create_next
			project_convey_page.text.include? "Price must be a number."
		end
		...
		it 'create convey with correct content and then click cancel' do
			...
			project_convey_page.title.should eql "GES ConVey TM - Capvision"
		end
		...
		it 'create step2 click save button with client_no' do
			...
			project_convey_page.text.include? "Client cannot be blank."
		end
		#建项目填写完整信息创建项目验证
		...
		it 'project info_page edit basic info with nothing and then save' do
			...
			project_convey_page.basic_edit_icon_element.when_present.click
			project_convey_page.text.include? "Project Description cannot be blank."
		end
		...
		it 'project info_page start date is more than end date and then save' do
			...
			project_convey_page.basic_edit_icon_element.when_present.click
			project_convey_page.text.include? "Start Date不能大于End Date"
		end
		...
		it 'consultants_task_list update  with task_no' do
			project_convey_page.goto_project
			project_convey_page.update_status_element.click
			project_convey_page.text.include? "You must select an action."
		end
		...
		it 'consultants_task_list edit mkt notes' do
			project_convey_page.goto_project
			project_convey_page.edit_mktnotes_element.click
			project_convey_page.mktnotes_input = "edit notes"
		...
		it 'consultants_task_list edit payment notes' do
			project_convey_page.goto_project
			project_convey_page.edit_paymentnotes_element.click
			project_convey_page.paymentnotes_input = "edit payment"
			project_convey_page.paymentnotes_save_element.click
		...
		it 'consultants_task_list upload normal document' do
			...
			project_convey_page.text.include? "NDB-Tables.doc"
		end
		##################以下用例逻辑已经更改，去掉############################################
		...
		it 'contacts_task_list update status with task_no' do
			...
			project_convey_page.select_status = "Completed"
			project_convey_page.update_status_element.click
			project_convey_page.text.include? "You must select a task."
		end
