...
describe 'international page', :international=>false do
   ...
   it 'edit client & contact' do
      ...
      international_page.edit_client_and_contact
   end  
   it 'change one I-consultation status to [on hold]' do
      ...
      sleep 2
      international_page.ident_change_status_element.when_present.text.should include "On Hold"
   end
   ...
   it 'change one I-consultation status to [invalid]' do
      ...
      international_page.pop_up_save_element.when_present.click
      sleep 2
      international_page.ident_change_status_element.when_present.text.should include "Invalid"
   end
   ...
   # it 'time order' do
   #    international_page.enter_int_task_list  
   #    international_page.first_task_edit_icon_element.when_present.click
   #    international_page.
   # end   
   ...
   it 'arg1 filling completed info and click cancel' do
      ...
      international_page.task_list_element.when_present.text.should include "Task List"
   end
   ...
   it 'complete task consultation date necessary identy' do
      ...
      international_page.complete_consultationDate_alert_element.when_present.text.should include "Consultation Date cannot be blank."
   end
   it 'complete task time order' do
      ...
      international_page.btn_complete_submit_element.when_present.click
      international_page.complete_startAndEndTime_alert_element.when_present.text.should include "Start Date"
   end
   it 'complete task type of interview necessary identy' do
      ...
      international_page.btn_complete_submit_element.when_present.click
      international_page.completet_typeOfInterview_alert_element.when_present.text.should include "Type Of Interview cannot be blank."
   end
   it 'complete task client hour necessary identy' do
      international_page.goto_complete_page
      international_page.complete_clientHour_element.when_present.clear
      international_page.btn_complete_submit_element.when_present.click
      international_page.complete_clientHour_alert_element.when_present.text.should include "Client Hour cannot be blank."
   end
   ...
   it 'complete task billing notes necessary identy' do
      ...
      international_page.btn_complete_submit_element.when_present.click
      international_page.complete_billingNotes_alert_element.when_present.text.should include "Billing Notes cannot be blank."
   end 
   it 'complete task consultant hour necessary identy' do
      ...
      international_page.btn_complete_submit_element.when_present.click
      international_page.complete_consultantHour_alert_element.when_present.text.should include "Consultant Hour cannot be blank."
   end
   it 'complete task consultant hour only for number identy' do
      international_page.goto_complete_page
      international_page.complete_consultantHour = "ABC"
      international_page.btn_complete_submit_element.when_present.click
      international_page.complete_consultantHour_alert_element.when_present.text.should include "Consultant Hour must be a number."
   end
   ...
   it 'field order' do
      ...
      international_page.date_link_element.when_present.click
      international_page.name_link_element.when_present.click
      international_page.cih_link_element.when_present.click     
      international_page.coh_link_element.when_present.click    
      international_page.coc_link_element.when_present.click     
      international_page.task_manager_link_element.when_present.click      
   end
   ...
   it 'completed task necessary consulation date identification' do
      international_page.enter_int_task_list
      international_page.first_task_edit_icon_element.when_present.click
      international_page.consultation_date_element.when_present.clear
      international_page.button_next_element.when_present.click
      international_page.task_save_alert_element.when_present.text.should include "Consultation Date cannot be blank."
   end
   it 'completed task necessary type of interview identification' do
      ...
      international_page.button_next_element.when_present.click
      international_page.task_save_alert_element.when_present.text.should include "Type Of Interview cannot be blank."
   end
   it 'completed task necessary client hour identification' do
      ...
      international_page.button_next_element.when_present.click
      international_page.task_save_alert_element.when_present.text.should include "Client Hour cannot be blank."
   end
   it 'completed task necessary billing notes identification' do
      ...
      international_page.button_next_element.when_present.click
      international_page.task_save_alert_element.when_present.text.should include "Billing Notes cannot be blank."
   end
   it 'completed task necessary consultant hour identification' do
      ...
      international_page.button_next_element.when_present.click
      international_page.task_save_alert_element.when_present.text.should include "Consultant Hour cannot be blank."
   end
   it 'edit task and save' do
      ...
      international_page.consultant_hour = "2"
      international_page.button_next_element.when_present.click
   end
   it 'edit task and cancel' do
      ...
      international_page.billing_notes = "test"
      international_page.consultant_hour = "2"
      international_page.btn_cancel_element.when_present.click
   end
   ...
   it 'cancel recommend a consultant which is not proper for project CA' do
      ...
      message.should == "Han's CA does not match project requirement .
Are you sure you wish to continue? . "
   end
   ...
   it 'sign red background for CA' do
      ...
      international_page.compliance_ca.when_present.select "ryanca"
   ...
   it 'sign red background for Training' do
      #红色背景标注Training不符合项目要求的顾问task
         international_page.enter_int_task_list
         international_page.compliance_info_element.when_present.click
         international_page.compliance_ca.when_present.select "N/A"
         international_page.compliance_compliance_training.when_present.click
         international_page.verify_row_is_red.should eql "red"
   end
   ...
   it "feedback necessary option identification" do
      #feedback必填验证
         international_page.button_search_element.when_present.click
         international_page.feedback_element.when_present.click
         international_page.popup_service_quality_element.when_present.select "-Please Choose-"
         # international_page.feedback_save_element.when_present.click
   ...
   it "INT task feedback popup" do
      ...
      international_page.task_feedback_popup_element.when_present.text.should eql "Task-Feedback"
   end
   it "INT task feedback necessary option" do
      international_page.enter_int_task_list
      international_page.task_feedback_element.when_present.click
      message = international_page.alert do
      international_page.task_feedback_save_element.when_present.click
      end
   ...
   it "create INT button page turning" do
      #创建INT按钮页面跳转
         ...
         international_page.h1_element.when_present.text.should eql "Create International Con sultation - Basic"
   end
   ...
   it 'INT create step 2 required option verification' do
      #创建INTstep2必填项验证
         ...
         international_page.text.should include "Client cannot be blank."
   end
   it 'INT create step 1 [consultant requested] number input verification' do
      #创建INTstep1顾问要求数量输入纯数字验证
         ...
         international_page.step1_next_element.when_present.click
         international_page.text.should include "Consultants Requested must be a number."
   end
   it 'INT create step 1 [consultant expected] number input verification' do
      #创建INTstep1顾问期望数量输入纯数字验证
         ...
         international_page.step1_next_element.when_present.click
         international_page.text.should include "Consultants Expected must be a number."
   end
   ...
   it 'INT project team edition' do
      #编辑项目参与人员
         ...
         international_page.project_manager_element.when_present.select "hamburgerKM"
         international_page.edit_project_team_element.when_present.click
         sleep 5
   ...
   it 'INT click [task list] link' do
      #task list点击跳转验证
         ...
         international_page.project_info_element.when_present.click
         international_page.task_list_element.when_present.click
         international_page.text.should include "ID"
   end
   ...
   it 'arrange a task not recommended' do
      ...
      international_page.arrange_alert_element.when_present.text.should include "The tasks cannot be arranged because it should be recommended first."
   end
   it 'complete a task not recommend' do
      international_page.enter_int_task_list
      international_page.task_checkbox0_element.when_present.click
      international_page.complete_first_task
      international_page.complete_notContact_task_alert_element.when_present.text.should include "You cannot complete this task before it has been recommended and arranged."
   end
   it 'INT go to project list identification' do
      #添加顾问成功后点击去到项目访谈列表页面
         ...
         international_page.task_list_element.when_present.text.should eql "Task List"
   end   
   ...
   it 'INT km notes submit' do
      #填写KMnotes并正确保存
         international_page.enter_int_task_list
         international_page.km_notes_element.when_present.click
         ...
         international_page.task_list_element.when_present.click
         international_page.km_notes_element.when_present.text.should eql "notes"
   end 
   ...
   it 'INT project compliance' do
         international_page.enter_int_task_list
         international_page.compliance_info_element.when_present.click
         international_page.compliance_req_element.when_present.text.should eql "Compliance Notes"        
   end
   ...
   it 'INT compliance CA' do
         ...
         international_page.task_list_element.when_present.click
         international_page.compliance_info_element.when_present.click
         international_page.compliance_ca_element.when_present.text.should eql "ryanca"
   end       
   it 'INT client info' do
         international_page.enter_int_task_list
         international_page.client_info_element.when_present.click
         international_page.client_name_element.when_present.text.should eql "Chicago Bulls"
   end    
