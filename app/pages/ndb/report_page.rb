...
class ReportPage < NdbPage
  ...
  element :client_type_cash, :td, :xpath=> "//tr[1]/td[4]"
  #select am
  ...
  #locate element client status
  element :client_status_clientcash_locate, :td, :xpath=> "//tr[1]/td[5]"
  #input date
  ...
  #click first client
  link :first_client_compliancecheck, :xpath=> "//tr[1]/td[3]/a"
  #click first project
