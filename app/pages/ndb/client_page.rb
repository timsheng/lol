...
class ClientPage < NdbPage
  ...
  #client name alert
  li :client_name_alert_a, :xpath=> "//form/div/div/div/ul/li"
  ...
  def client_table_list_type
    self.client_list_element[self.num.to_i][5].text
  end
  
  def client_table_list_type1
    self.client_list_element[2][5].text
  end
  
  def client_table_list_am
    self.client_list_element[self.num.to_i][1].text
  end
