...
class InternationalPage < NdbPage
  ...
  text_field :task_checkbox0, :id=> "task-grid_c0_0"
  text_field :task_checkbox1, :id=> "task-grid_c0_1"
  select_list :task_action, :id=> "action"
  button :task_update, :id=> "taskupdate-btn"
  text_field :change_status, :id=> "change-status"
  ...
  label :compliance_training, :xpath=>"div[2]/div/div[4]/div[2]/div/div/label"
  ...
  element :verify_row_red_ornot, :tr ,:xpath=> "//table/tbody/tr[2]"
  link :send_ca, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[2]/a"
  link :resend_ca, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[3]/a"
  link :sign_ca, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[4]/a"
  button :btn_send_ca, :id=>"compliance-send-submit"
  link :resend_display, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[20]/div[3]/a'
  div :ident_change_status, :xpath=>'//div[3]/div/div/div[1]'
  div :ident_ca_send, :xpath=>"//div[3]/div/div/div[1]"
  element :upload_ca_file, :i, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[5]/a/i"
  ...
  element :task_feedback, :i, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[1]/a[2]/i"
  span :task_feedback_popup, :xpath=>"//div[9]/div[1]/span"
  ...
  element :approval_icon, :i, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[20]/div[5]/a[2]/i"
  link :resend_ca, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[3]/a"
  span :client_name, :xpath=>"//div[3]/div[1]/div/div/div[1]/div[1]/span[2]"
  element :update_icon, :i, :xpath=>"//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[1]/a[1]/i"
  ...
  img :high_rate, :xpath=>"//tr[1]/td[8]/div/img"
  element :upload_file ,:i ,:xpath=> "//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[18]/div[5]/a[1]/i"
  file_field :ndb_file_upload_input ,:id=> "ndb-file-upload-input"
  button :ndb_file_upload_btn ,:id=> "ndb-file-upload-upload-btn"
  link :download_file, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[17]/a[1]'
  element :delete_file, :i, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[17]/a[2]/i'
  link :id_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[2]/a"
  link :status_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[3]/a"
  link :date_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[6]/a"
  link :name_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[9]/a"
  link :cih_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[13]/a"
  link :coh_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[14]/a"
  link :coc_link, :xpath=>"//div[3]/div/div/form/div[2]/table/thead[1]/tr/th[15]/a"
  ...
  link :arrange_next_button, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[2]/input[1]'
  link :arrange_send_email, :id=>'send-email'
  element :edit_client_icon, :i, :xpath=>'//div[3]/div/div/div[1]/div/div[2]/a/i'
  text_field :client_contact, :xpath=>'//div[3]/div/div/div[1]/div/div[2]/div/div/form/div[2]/div/div/ul/li/input'
  text_field :client_project_manager, :xpath=>'//div[3]/div/div/div[1]/div/div[2]/div/div/form/div[3]/div/div/ul/li/input'
  ###
  link :consultant_link0, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[10]/div/a'
  ...
  div :task_grid, :xpath=>'//div[3]/div/div/form/div[2]'
  element :first_task_edit_icon, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[20]/div[1]/a[1]/i'
  checkbox :select_first_task, :id=>'task-grid_c0_0'
  element :first_task_edit_icon, :i, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[17]/div[1]/a[1]/i'
  ...
  link :btn_cancel, :xpath=>"//div[2]/div/div/div/div/form/div[3]/a"
  ...
  link :rec_step1_consultant_namelink, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[1]/span[2]/a'
  text_field :rec_step1_id, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[3]/div[1]/span[2]/input'
  span :id_alert, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[3]/div[1]/span[2]/span'
  element :rec1_choose_workexp, :i, :xpath=>"//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[3]/div[2]/span[3]/i"
  ...
  span :email_to, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[1]/div[3]/span[1]'
  text_field :btn_rec2_previous, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[2]/input[1]'
  text_field :btn_rec2_cancel, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[2]/input[3]'
  ...
  text_field :btn_arg1_next, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[2]/input[1]'
  text_field :btn_arg1_change_status, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[2]/input[2]'
  text_field :btn_arg1_cancel, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[2]/input[3]'
  span :arg1_consultation_date_alert, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[3]/div[1]/span[2]/span[4]'
  span :arg1_consultation_date_past_alert, :xpath=>'//div[2]/div/div[1]/form/div/div/div[1]/div[1]/div[3]/div[1]/span[2]/span[5]'
  ...
  text_field :arg2_sendCalendar, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[1]/label/input'
  span :arg2_calendarTo, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[1]/div[4]/span[1]'
  text_field :btn_arg2_previous, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[2]/input[1]'
  text_field :btn_arg2_cancel, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[2]/input[3]'
  text_field :btn_arg2_sendEmailToClient, :xpath=>'//div[2]/div/div[1]/form/div/div/div[2]/div[2]/input[2]'
  button :btn_arg2_popup_ok, :xpath=>'//div[4]/div[3]/div/button[1]'
  ...
  text_field :complete_consultationDate, :xpath=>'//div[2]/div/div/div/div/form/div[1]/div/div[2]/div/div/input'
  ...
  text_area :complete_billingNotes, :xpath=>'//div[2]/div/div/div/div/form/div[2]/div/div[2]/div/textarea'
  span :complete_billingNotes_alert, :xpath=>'//div[2]/div/div/div/div/form/div[3]/div/div[2]/div/span'
  text_field :complete_consultantHour, :xpath=>'//div[2]/div/div/div/div/form/div[2]/div/div[3]/div/input'
  span :complete_co
  text_field :btn_complete_submit, :xpath=>'//div[2]/div/div/div/div/form/div[4]/input[1]'
  text_field :btn_complete_cancel, :xpath=>'//div[2]/div/div/div/div/form/div[4]/input[2]'
  span :complete_consultationDate_alert, :xpath=>'//div[2]/div/div/div/div/form/div[2]/div/div[2]/div/span'
  text_field :complete_startTime, :xpath=>'//div[2]/div/div/div/div/form/div[1]/div/div[3]/div/div[1]/input'
  text_field :complete_endTime, :xpath=>'//div[2]/div/div/div/div/form/div[1]/div/div[4]/div/div[1]/input'
  ...
  element :task_status_alert, :td, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr/td[3]'
  ...
  element :task_status, :td, :xpath=>'//div[3]/div/div/form/div[2]/table/tbody/tr[1]/td[3]'
  ...
  def complete_with_necInfo
      self.complete_consultationDate = "2010-10-10"
      self.complete_startTime = "13:00"
      self.complete_endTime = "14:00"
      self.complete_typeOfInterview_element.when_present.select "Phone"
      self.complete_billingNotes = "test billing notes"
      self.complete_clientHour = "2"
      self.complete_consultantHour = "2"
  end
  ...
  def task_feedback_info_fillin
      ...
      self.task_feedback_save_element.when_present.click
  end



  # span :name_blank, :xpath=>"//div[2]/div/span"
  # span :description_blank, :xpath=>"//div[4]/div/span"
  # span :start_date_blank, :xpath=>"//div[5]/div/span"
  ...
  #   self.project_description = "ryan test description"
  #   self.basic_edit_icon_element.when_present.click
  # end
...
#task文档上传end
  ...
  def set_ca
      ...
      self.ca_element.when_present.select "ryanca"
  ...
  ###
  def edit_client_and_contact
      self.edit_client_icon_element.when_present.click
      self.client_contact_element.when_present.click
      self.send_keys :enter
      # self.client_project_manager.when_present.click
      # self.send_keys :enter
      # self.save_client_icon_element.when_present.click
      self.edit_client_icon_element.when_present.click
  end 
