...
class ProjectConferencePage < Lol::Page
  ...
  button :goto_projectlist ,:text => "Go to this project list"
  ...
  button :cocash_cancel, :xpath=> "//div[6]/div[3]/div/button[2]"
  ...
  def add_contacts
    ...
    sleep 1
    self.check_client_contact_grid
    sleep 1
    self.add_contact_to_contacts_task
    sleep 4
    self.goto_project_list
    sleep 2
  end
